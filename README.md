...
**AFKStatus** is a lightweight, server-side mod for **Minecraft 1.21.11**, available for **Forge**, **NeoForge**, and **Fabric**. It automatically tracks player activity and marks users as AFK (Away From Keyboard) when they stop moving or chatting for a configurable period. Players can also manually toggle AFK status using a simple `/afk` command.
...
1. Install your preferred mod loader (**Forge**, **NeoForge**, or **Fabric** with Fabric API) on your Minecraft 1.21.11 server.
